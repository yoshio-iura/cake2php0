<?php
App::uses('JuhacchuuDt', 'Model');

/**
 * JuhacchuuDt Test Case
 */
class JuhacchuuDtTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->JuhacchuuDt = ClassRegistry::init('JuhacchuuDt');
	}
