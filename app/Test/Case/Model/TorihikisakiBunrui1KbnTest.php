<?php
App::uses('TorihikisakiBunrui1Kbn', 'Model');

/**
 * TorihikisakiBunrui1Kbn Test Case
 */
class TorihikisakiBunrui1KbnTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TorihikisakiBunrui1Kbn = ClassRegistry::init('TorihikisakiBunrui1Kbn');
	}
 ...
 */
	public function tearDown() {
		unset($this->TorihikisakiBunrui1Kbn);
