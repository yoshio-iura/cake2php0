<?php
App::uses('TorihikisakiBunrui2Kbn', 'Model');

/**
 * TorihikisakiBunrui2Kbn Test Case
 */
class TorihikisakiBunrui2KbnTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TorihikisakiBunrui2Kbn = ClassRegistry::init('TorihikisakiBunrui2Kbn');
	}
 ...
 */
	public function tearDown() {
		unset($this->TorihikisakiBunrui2Kbn);
