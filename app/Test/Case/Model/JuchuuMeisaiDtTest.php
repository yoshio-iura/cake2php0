<?php
App::uses('JuchuuMeisaiDt', 'Model');

/**
 * JuchuuMeisaiDt Test Case
 */
class JuchuuMeisaiDtTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->JuchuuMeisaiDt = ClassRegistry::init('JuchuuMeisaiDt');
	}
