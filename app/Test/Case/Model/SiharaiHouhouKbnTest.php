<?php
App::uses('SiharaiHouhouKbn', 'Model');

/**
 * SiharaiHouhouKbn Test Case
 */
class SiharaiHouhouKbnTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SiharaiHouhouKbn = ClassRegistry::init('SiharaiHouhouKbn');
	}
