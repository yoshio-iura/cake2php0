<?php
App::uses('HacchuuMeisaiDt', 'Model');

/**
 * HacchuuMeisaiDt Test Case
 */
class HacchuuMeisaiDtTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HacchuuMeisaiDt = ClassRegistry::init('HacchuuMeisaiDt');
	}
