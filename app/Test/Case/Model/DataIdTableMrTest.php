<?php
App::uses('DataIdTableMr', 'Model');

/**
 * DataIdTableMr Test Case
 */
class DataIdTableMrTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->DataIdTableMr = ClassRegistry::init('DataIdTableMr');
	}
