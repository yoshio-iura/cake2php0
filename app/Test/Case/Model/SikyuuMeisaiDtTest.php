<?php
App::uses('SikyuuMeisaiDt', 'Model');

/**
 * SikyuuMeisaiDt Test Case
 */
class SikyuuMeisaiDtTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SikyuuMeisaiDt = ClassRegistry::init('SikyuuMeisaiDt');
	}
