<?php
App::uses('TorihikisakiBunrui4Kbn', 'Model');

/**
 * TorihikisakiBunrui4Kbn Test Case
 */
class TorihikisakiBunrui4KbnTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TorihikisakiBunrui4Kbn = ClassRegistry::init('TorihikisakiBunrui4Kbn');
	}
 ...
 */
	public function tearDown() {
		unset($this->TorihikisakiBunrui4Kbn);
