<?php
App::uses('JournalKongenMr', 'Model');

/**
 * JournalKongenMr Test Case
 */
class JournalKongenMrTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->JournalKongenMr = ClassRegistry::init('JournalKongenMr');
	}
