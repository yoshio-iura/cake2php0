<?php
App::uses('SiharaiTukiKbn', 'Model');

/**
 * SiharaiTukiKbn Test Case
 */
class SiharaiTukiKbnTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SiharaiTukiKbn = ClassRegistry::init('SiharaiTukiKbn');
	}
