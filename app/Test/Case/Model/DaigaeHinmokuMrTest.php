<?php
App::uses('DaigaeHinmokuMr', 'Model');

/**
 * DaigaeHinmokuMr Test Case
 */
class DaigaeHinmokuMrTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->DaigaeHinmokuMr = ClassRegistry::init('DaigaeHinmokuMr');
	}
