<?php
App::uses('JuhacchuuMeisaiDt', 'Model');

/**
 * JuhacchuuMeisaiDt Test Case
 */
class JuhacchuuMeisaiDtTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->JuhacchuuMeisaiDt = ClassRegistry::init('JuhacchuuMeisaiDt');
	}
