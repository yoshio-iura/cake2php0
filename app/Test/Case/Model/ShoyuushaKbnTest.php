<?php
App::uses('ShoyuushaKbn', 'Model');

/**
 * ShoyuushaKbn Test Case
 */
class ShoyuushaKbnTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ShoyuushaKbn = ClassRegistry::init('ShoyuushaKbn');
	}
