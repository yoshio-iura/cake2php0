<?php
App::uses('SiiresakiMr', 'Model');

/**
 * SiiresakiMr Test Case
 */
class SiiresakiMrTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SiiresakiMr = ClassRegistry::init('SiiresakiMr');
	}
