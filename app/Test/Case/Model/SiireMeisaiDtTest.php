<?php
App::uses('SiireMeisaiDt', 'Model');

/**
 * SiireMeisaiDt Test Case
 */
class SiireMeisaiDtTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SiireMeisaiDt = ClassRegistry::init('SiireMeisaiDt');
	}
