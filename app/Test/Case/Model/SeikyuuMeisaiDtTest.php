<?php
App::uses('SeikyuuMeisaiDt', 'Model');

/**
 * SeikyuuMeisaiDt Test Case
 */
class SeikyuuMeisaiDtTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SeikyuuMeisaiDt = ClassRegistry::init('SeikyuuMeisaiDt');
	}
