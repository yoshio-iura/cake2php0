<?php
App::uses('HinmokuBunrui2Kbn', 'Model');

/**
 * HinmokuBunrui2Kbn Test Case
 */
class HinmokuBunrui2KbnTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HinmokuBunrui2Kbn = ClassRegistry::init('HinmokuBunrui2Kbn');
	}
