<?php
App::uses('HinmokuBunrui4Kbn', 'Model');

/**
 * HinmokuBunrui4Kbn Test Case
 */
class HinmokuBunrui4KbnTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HinmokuBunrui4Kbn = ClassRegistry::init('HinmokuBunrui4Kbn');
	}
