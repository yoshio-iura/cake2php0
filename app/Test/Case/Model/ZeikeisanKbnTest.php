<?php
App::uses('ZeikeisanKbn', 'Model');

/**
 * ZeikeisanKbn Test Case
 */
class ZeikeisanKbnTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ZeikeisanKbn = ClassRegistry::init('ZeikeisanKbn');
	}
