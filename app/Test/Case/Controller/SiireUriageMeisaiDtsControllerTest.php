<?php
App::uses('SiireUriageMeisaiDtsController', 'Controller');

/**
 * SiireUriageMeisaiDtsController Test Case
 */
class SiireUriageMeisaiDtsControllerTest extends ControllerTestCase {
