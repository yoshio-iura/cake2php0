<?php
App::uses('TorihikisakiBunrui2KbnsController', 'Controller');

/**
 * TorihikisakiBunrui2KbnsController Test Case
 */
class TorihikisakiBunrui2KbnsControllerTest extends ControllerTestCase {
