<?php
App::uses('FurikomiHouhouKbnsController', 'Controller');

/**
 * FurikomiHouhouKbnsController Test Case
 */
class FurikomiHouhouKbnsControllerTest extends ControllerTestCase {
