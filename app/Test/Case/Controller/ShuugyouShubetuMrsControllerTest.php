<?php
App::uses('ShuugyouShubetuMrsController', 'Controller');

/**
 * ShuugyouShubetuMrsController Test Case
 */
class ShuugyouShubetuMrsControllerTest extends ControllerTestCase {
