<?php
App::uses('TorihikisakiBunrui5KbnsController', 'Controller');

/**
 * TorihikisakiBunrui5KbnsController Test Case
 */
class TorihikisakiBunrui5KbnsControllerTest extends ControllerTestCase {
