<?php
App::uses('TorihikisakiBunrui4KbnsController', 'Controller');

/**
 * TorihikisakiBunrui4KbnsController Test Case
 */
class TorihikisakiBunrui4KbnsControllerTest extends ControllerTestCase {
