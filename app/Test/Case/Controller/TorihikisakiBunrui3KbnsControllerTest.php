<?php
App::uses('TorihikisakiBunrui3KbnsController', 'Controller');

/**
 * TorihikisakiBunrui3KbnsController Test Case
 */
class TorihikisakiBunrui3KbnsControllerTest extends ControllerTestCase {
