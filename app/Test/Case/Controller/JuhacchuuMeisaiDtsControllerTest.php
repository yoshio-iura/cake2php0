<?php
App::uses('JuhacchuuMeisaiDtsController', 'Controller');

/**
 * JuhacchuuMeisaiDtsController Test Case
 */
class JuhacchuuMeisaiDtsControllerTest extends ControllerTestCase {
