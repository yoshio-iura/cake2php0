<?php
App::uses('TorihikisakiBunrui1KbnsController', 'Controller');

/**
 * TorihikisakiBunrui1KbnsController Test Case
 */
class TorihikisakiBunrui1KbnsControllerTest extends ControllerTestCase {
